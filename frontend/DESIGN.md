...
```
# SentinelAI Design Extensions

> Extensions to the Trigger.dev design system for security operations workflows, alerts, investigations, and threat intelligence interfaces.
...
| ------------- | --------- | ---------------------------------------------- |
| Critical      | `#f43f5e` | Critical alerts, high-risk incidents           |
| High          | `#fa3abf` | High-priority alerts and escalations           |
| Medium        | `#9c9af2` | Medium-priority alerts and investigations      |
| Low           | `#afec73` | Low-priority alerts and informational findings |
| Informational | `#878c99` | Informational events and metadata              |

### Rules

* Use severity colors only for:
...
* Never:
  ...
  * Use severity colors as page backgrounds
  * Use severity colors for large surfaces
  * Use severity colors as button fills
...
```text
Severity | Alert | Source | Host | Time | Status
```
...
The SentinelAI interface is an analyst workstation, not a marketing website.
...
Every screen should feel operational, dense, and actionable rather than promotional.
